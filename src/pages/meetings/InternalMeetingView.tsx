...
import { MeetingReportButton } from '@/components/meetings/MeetingReportButton'
...
export function InternalMeetingView() {
  ...
  const { data: attachments = [] } = useMeetingAttachments('internal', id!)
  ...
  if (!meeting) {
    return <div className="p-4 sm:p-6"><EmptyState title="Meeting not found" action={<Button asChild><Link to="/meetings/internal">Back</Link></Button>} /></div>
  }
  ...
  return (
    <div className="p-4 sm:p-6 space-y-4 max-w-3xl mx-auto">
      ...
      {displayPic && (
        <div className="relative h-44 sm:h-60 w-full overflow-hidden rounded-xl shadow-sm">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4">
            <p className="text-[10px] font-semibold uppercase tracking-widest text-white/70 mb-0.5">Internal Meeting</p>
      ...
      <PageHeader
        ...
        subtitle={partnership?.title ?? undefined}
        actions={
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <MeetingReportButton meeting={m} meetingType="internal" />
